...
function Subscription() {
  ...
  return (
    <div className="mx-auto">
        <div className="relative isolate overflow-hidden px-6 py-10 shadow bg-[#1e2126] w-full flex flex-col items-center">
            ...
            >
                ...
                <input
                    ...
                    required
                    value={email}
                    // Keep the input value in sync with newsletter email state.
